...
namespace OxyPlot.Xamarin.iOS
{
    ...
    /// </summary>
    [Register("PlotViewGL")]
    public class PlotViewGL : GLKView, IGLKViewDelegate, IPlotView
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OxyPlot.Xamarin.iOS.PlotViewGL"/> class.
        /// </summary>
        public PlotViewGL()
        {
            this.Initialize ();
        ...
        public PlotViewGL(CoreGraphics.CGRect frame) : base(frame)
        {
            this.Initialize ();
        }
        ...
        public PlotViewGL(NSCoder coder) : base (coder)
        {
            this.Initialize ();
        }
        ...
        public new void DrawInRect(GLKView view, CGRect rect)
        {
            ...
            _renderTarget.Width = (int)DrawableWidth;
            _renderTarget.Height = (int)DrawableHeight;

            var actualModel = (IPlotModel)this.model;
            if (actualModel != null)
            {
                using (var surface = SKSurface.Create(_context, _renderTarget))
                {
                    ...
                    {
                        skcanvas.Clear(new SKColor(255, 255, 255));
                    }
